...
import singleInstance from "./singleInstance.cjs";
import dynamicRenderer from "./dynamicRenderer.cjs";
import titleBarActionsModule from "./modules/titleBarActions.cjs";
import updaterModule from "./modules/updater.cjs";
import macMenuModule from "./modules/macMenu.cjs";
